...
export class GroupsComponent implements OnInit {
  ...
  columnDefs = [
    ...
    {headerName: this.Rtl ? 'الاسم العربى' : 'Arabic Name', field: 'groupName',  width: 150 , sortable: true, filter: true},
    {headerName: this.Rtl ? 'الاسم الانجليزى' : 'English  Name', field: 'groupLatName',  width: 200 , sortable: true, filter: true}
  ];
